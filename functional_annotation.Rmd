...
Piano is an R-package for carrying out gene-set analysis (see more info [here](www.sysbio.se/piano)).

`r sn<-sn+1; paste(sn,". ", sep="")` First we need to import some gene-sets. Load GO-terms from MSigDB:
